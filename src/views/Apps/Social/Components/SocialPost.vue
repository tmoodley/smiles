<template>
  <iq-card body-class="p-0">
      ...
      <div class="-data p-3">
        <div class="d-flex flex-wrap">
          ...
          <div class="media-support-info mt-2">
            ...
            <p class="mb-0 text-primary">{{post.time | formatDate }}</p>
          </div>
    ...
    <div class="">
      ...
      <div id="photo-grid" class="w-100 px-3">
        <photo-grid :box-height="'400px'" :box-width="'100%'" :boxBorder=2>
          <img class="rounded-lg " v-for="(image, index) in post.images" :src="image" :key="index" />
        </photo-grid>
      </div>
    </div>
    <div class="comment-area p-3">
      ...
      <b-form class="comment-text d-flex align-items-center mt-3" action="javascript:void(0);">
        <b-form-input type="text" @keyup.enter="saveComment(commentMessage)" v-model="commentMessage" class="rounded" placeholder="" />
