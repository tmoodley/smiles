          ...
          <div class="mainDiv">
            <b-form @submit="onSubmit" @reset="onReset" v-if="show">
              ...
              <b-row v-if="selectedContact != ''">
                <b-col>
                  <p style="letter-spacing: 0.2px; color: #00AC4E;font-weight:bold;font-size:12px;cursor:pointer">Student: {{selectedContact.emailAddress}} <i class="fa fa-trash" aria-hidden="true" @click="$bvModal.show('modal-find-user')"></i></p>
                </b-col>
              </b-row>
              ...
              <b-row>
                <b-col>
                  <b-button :disabled="loading" type="submit" variant="primary" block>
                    Confirm
