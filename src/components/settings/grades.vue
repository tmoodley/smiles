      ...
      <b-col cols="12" sm="12" md="12" lg="6" xl="6">
        <div class="card gedf-card">
          <div class="card-body">
            ...
            <p class="card-text">
              <b-form-group label="Please Select Grades You Teach"
...
export default {
  ...
  computed: {
    ...mapState({
      subjects: State => State.posts.grades
    }),
    ...mapState({
  ...
  mounted: function () {
    ...
    this.getGrades().then(function () {
      for (var grade of self.grades) {
        self.options.push({ text: grade.name, value: grade.id })
      }
    })
    this.OrganizationId = JSON.parse(localStorage.getItem('organizationId'))
    if (this.company.organizationGrades != null) {
      for (var grade of self.company.organizationGrades) {
        self.selected.push(grade.gradeId)
      }
    }
  }
}
