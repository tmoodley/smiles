        ...
        <b-col class="main-container main-hover-div">
          <b-row class="mt-2" style="background-color: white; box-shadow: 0px 4px 10px #CFDEE66C;">
            ...
            <b-col cols="6" sm="6" md="6" lg="2" xl="2" class="p-2">
              ...
              <b-button style="width: 160px; height: 52px; background: white; color: #576367; border: 1px solid #576367;" class="mt-4" @click="select(tutor)">Assign</b-button>
            </b-col>
...
export default {
  ...
  methods: {
    ...
    select (org) {
      var self = this
      debugger
      this.room.AssignedTutorId = org.organizationId
      this.editRoom(this.room)
      this.$nextTick(() => {
        self.$bvModal.hide('modal-find-tutor')
      })
    }
  },
  computed: {
